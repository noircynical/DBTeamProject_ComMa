...
load data infile '/Users/apple/Downloads/comma/data/brand.txt' into table dbcourse_brand;
load data infile '/Users/apple/Downloads/comma/data/location.txt' into table dbcourse_location;
load data infile '/Users/apple/Downloads/comma/data/menu_spec.txt' into table dbcourse_menu_spec;
load data infile '/Users/apple/Downloads/comma/data/menu.txt' into table dbcourse_menu;
load data infile '/Users/apple/Downloads/comma/data/person.txt' into table dbcourse_person;
load data infile '/Users/apple/Downloads/comma/data/atmosphere.txt' into table dbcourse_atmosphere;
load data infile '/Users/apple/Downloads/comma/data/restaurant.txt' into table dbcourse_restaurant;
load data infile '/Users/apple/Downloads/comma/data/position.txt' into table dbcourse_position;
load data infile '/Users/apple/Downloads/comma/data/evaluation.txt' into table dbcourse_evaluation;
load data infile '/Users/apple/Downloads/comma/data/employee.txt' into table dbcourse_employee;
load data infile '/Users/apple/Downloads/comma/data/customer.txt' into table dbcourse_customer;
load data infile '/Users/apple/Downloads/comma/data/reservation.txt' into table dbcourse_reservation;
